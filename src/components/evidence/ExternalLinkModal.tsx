        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
          ...
          <div className="pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="order-1 sm:order-2 flex items-center justify-center gap-2 bg-moe-800 hover:bg-moe-900 text-white text-xs font-bold px-5 py-2.5 rounded-xl transition-colors disabled:opacity-50 shadow-sm w-full sm:w-auto"
            >
